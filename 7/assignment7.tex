...
Originally, the $p$-value was $\intg{c}{\infty}{f(t;k)}{t}$, but the new $p$-value becomes $\intg{kc}{\infty}{f(t;k)}{t}$. Thus, the $p$ value reduces, since $k>1\implies kc>c$, increasing the chances of rejecting the null.
